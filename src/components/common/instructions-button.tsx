...
const instructions = [
  ...
  },
  {
    ...
    description:
      'Chọn "Mua khóa học" để tiến hành thanh toán và chờ xác nhận từ quản trị viên để bắt đầu học. Khóa học miễn phí không cần xác nhận.',
    image: '/enroll.png'
  },
  {
    title: 'Học tập',
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant='outline'
          className='gap-2 transition-all duration-300 ease-in-out hover:bg-primary hover:text-white'
        >
      ...
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          <DialogTitle>Hướng dẫn dùng hệ thống e-learning</DialogTitle>
          <DialogDescription>

...
export const CourseManage = ({ courses }: ICourseManageProps) => {
            ...
            courses.map((course) => {
              ...
              return (
                <TableRow key={course.slug}>
                  ...
                  <TableCell>
                    <TableAction>
                      <TableActionItem type='study' url={`/manage/course/update-content?slug=${course.slug}`} />
                      <TableActionItem type='view' url={`/course/${course.slug}`} />
                      <TableActionItem type='edit' url={`/manage/course/update?slug=${course.slug}`} />
                      <TableActionItem type='delete' onClick={() => handleDeleteCourse(course.slug)} />
                    </TableAction>
                  </TableCell>
                </TableRow>
              )
